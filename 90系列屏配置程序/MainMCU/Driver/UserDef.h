...
//	#define MD070STN92		//1024x600 MD070STN92
...
//	#define	HSD123JWP				//1920x720
//	#define	HSD088IPW1				//480*1920
	#define	VT070IWXM				//280*1424
...
#define LCD_legth  1424
#define canvas_image_width  LCD_width

///*=========== layer ===========*/ 
#define Layer1	0
#define Layer2	LCD_legth*LCD_width*3
#define Layer3	LCD_legth*LCD_width*3*2
#define Layer4	LCD_legth*LCD_width*3*3
#define Layer5	LCD_legth*LCD_width*3*4
#define Layer6	LCD_legth*LCD_width*3*5
#define Layer7	LCD_legth*LCD_width*3*6
#define Layer8	LCD_legth*LCD_width*3*7
#define Layer9	LCD_legth*LCD_width*3*8
#define Layer10	LCD_legth*LCD_width*3*9
...
#define DRAM_FREQ	166	// SDRAM clock frequency, unit: MHz. 
#define CORE_FREQ	133	// Core (system) clock frequency, unit: MHz. 
#define SCAN_FREQ	38	// Panel Scan clock frequency, unit: MHz.
